        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" style="width: 700;" id="accordionSidebar">
            ...
            <li class="nav-item dropdown">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="cards.html">Transaksi Pembayaran</a>
                        <a class="collapse-item" href="cards.html">History Transaksi</a>
                    </div>
                </div>
            </li>
            <!-- <li class="nav-item">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-center pt-4">
                        <video width="" height="470" muted autoplay loop>
