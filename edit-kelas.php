                    ...
                    <div class="cut">
                        <form class="" method="post" action="">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?= $kelas['nama']?>" name="nama" id="nama">
                            </div>
                            <div class="mb-3">
                                <label for="jurusan" class="form-label">Masukan Jurusan</label>
                                <input type="text" class="form-control" value="<?= $kelas['jurusan']?>" name="jurusan" id="jurusan">
                            </div>

                            <button type="sumbit" class="btn-block btn-success btn">
                                <a href=""></a> Sumbit
                            </button>
                        </form>
                    </div>
